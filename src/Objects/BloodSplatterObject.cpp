#include "./BloodSplatterObject.h"
#include <iostream>

// copied from https://github.com/livinamuk/Hell2025
BloodSplatterObject::BloodSplatterObject(glm::vec3 position, glm::vec3 forward) {
...
void BloodSplatterObject::Update(float deltaTime) {
